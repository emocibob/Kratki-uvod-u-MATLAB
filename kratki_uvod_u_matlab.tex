...
Korištena je naredba \texttt{subplot} koja dijeli \emph{figure} na koordinatni sustav\footnote{\texttt{subplot(m, n, p)} dijeli \emph{figure} u $m \times n$ koordinatni sustav u kojem smještamo graf na poziciju (ili više njih) \texttt{p}.} u kojemu smještamo grafove.
...
\caption{Primjer više grafova na jednom \emph{figure}.}
\label{fig:subplot}
\end{figure}
